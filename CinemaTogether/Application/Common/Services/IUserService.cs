...
public interface IUserService
{
    ...
    Task SetUserFavouriteGenresAsync(Guid userId, List<Guid> genresIds, CancellationToken cancellationToken);
    
    Task<List<GenreDto>> GetUserFavouriteGenresAsync(Guid userId, CancellationToken cancellationToken);
